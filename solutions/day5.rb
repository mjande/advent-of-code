...
def parse_procedure(string) 
  ...
  return { num_of_crates: numbers[0], original_pile: numbers[1] - 1, new_pile: numbers[2] - 1 }
end

def execute_procedure_for_5000(hash, piles)
...
def execute_procedure_for_5001(hash, piles)
